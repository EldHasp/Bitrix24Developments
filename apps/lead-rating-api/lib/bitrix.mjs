  ...
  <div class="wrap">
    ...
    <div id="panel" style="display:none">
      <div class="card">
        <h2>Что это</h2>
        <ul>
          <li>Считает рейтинг лида (А+ / А / В / С) по 7 критериям категории клиента.</li>
      ...
      <div class="card">
        ...
        <ul>
          <li><b>Брать пустые поля из лида</b> = Да</li>
          <li><b>Записать рейтинг в лид</b> = Да</li>
          <li>7 критериев можно оставить «не установлено»</li>
